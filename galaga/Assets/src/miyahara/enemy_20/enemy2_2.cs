...
public class enemy2_2 : MonoBehaviour {
    ...
    void Start () {
        myBezier6 = new Bezier(new Vector3(-2f, 6f, 0f), new Vector3(-1f, -5f, 0f), new Vector3(4f, 4f, 0f), new Vector3(5f, -1f, 0f));
        //StartCoroutine(Exec2());
        myBezier9 = new Bezier5(new Vector3(5f, -1f, 0f), new Vector3(-4f, -4f, 0f), new Vector3(0f, 0f, 0f), new Vector3(0.8f, 3.7f, 0f));
