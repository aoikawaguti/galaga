...
public class enemy4_6 : MonoBehaviour {
    ...
    void Start () {
        ...
        myBezier11 = new Bezier5(new Vector3(5f, -0.5f, 0f), new Vector3(-2f, -4f, 0f), new Vector3(-0.4f, -1.5f, 0f), new Vector3(-3.2f, 2.9f, 0f));
    }
