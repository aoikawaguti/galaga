...
public class e63 : MonoBehaviour {
    ...
    void Start () {
        myBezier7 = new Bezier(new Vector3(2f, 6f, 0f), new Vector3(1f, -5f, 0f), new Vector3(-4f, 4f, 0f), new Vector3(-5f, -1f, 0f));
        myBezier9 = new Bezier5(new Vector3(-5f, -1f, 0f), new Vector3(4f, -4f, 0f), new Vector3(0f, 0f, 0f), new Vector3(2.4f, 1.3f, 0f));
