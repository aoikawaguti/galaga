...
public class e61 : MonoBehaviour {
	...
	void Update () {
        myBezier5 = new Bezier(new Vector3(4f, 5.5f, 0f), new Vector3(-15f, 2f, 0f), new Vector3(-1f, -13f, 0f), new Vector3(2.4f, 2.1f, 0f));
        Vector3 pos = myBezier5.GetPointAtTime(t);
